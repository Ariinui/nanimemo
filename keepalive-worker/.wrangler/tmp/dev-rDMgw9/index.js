...
async function ping(env) {
  ...
  return { ok, status: res.status, at: (/* @__PURE__ */ new Date()).toISOString() };
}
__name(ping, "ping");
var src_default = {
  async scheduled(_event, env) {
    ...
    if (!r.ok) throw new Error(`Supabase ne r\xE9pond pas correctement (HTTP ${r.status})`);
  },
...
// .wrangler/tmp/bundle-HAzRfq/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-HAzRfq/middleware-loader.entry.ts
